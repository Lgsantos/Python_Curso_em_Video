...
radbutton1 = Radiobutton(moldura, text = 'Centímetros', variable = var1,
                         value = 1, command = escolhas, bg = '#CCFFFF')
radbutton1.pack(padx = 10, pady = 5)

radbutton2 = Radiobutton(moldura, text = 'Milímetros', variable = var1,
                         value = 2, command = escolhas, bg = '#CCFFFF')
radbutton2.pack(padx = 10, pady = 5)
